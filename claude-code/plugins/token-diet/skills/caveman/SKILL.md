...
name: caveman
description: >-
  Terse, fragment-style output to cut response tokens ~65%. Use when the user says "caveman", "be terse", "save output tokens", "short answers", or wants minimal prose. Ported from JuliusBrussee/caveman.
---
