...
Frameworks (charter quality, variable identification, state model, implicit-expectation lenses) live in `dev-team-knowledge/exploratory-testing-field-guide.md`; this file is the protocol.
