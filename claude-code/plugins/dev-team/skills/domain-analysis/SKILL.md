...
This skill is analytical, not prescriptive. It describes what *is*, not what should be built. For greenfield design, use `the /domain-driven-design skill`. For code-level violations (anemic model, missing DTOs, wrong layer), use `agents/domain-review.md`.
