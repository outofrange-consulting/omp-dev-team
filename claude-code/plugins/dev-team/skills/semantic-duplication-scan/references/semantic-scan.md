...
Apply the guidelines defined in the /semantic-duplication-scan skill to the current task. Read the skill file and follow its process flow, pre-filter rules, annotation procedure, clustering strategy, and report format.
