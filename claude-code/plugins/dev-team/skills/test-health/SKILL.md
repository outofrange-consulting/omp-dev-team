...
Grounded in: `dev-team-knowledge/testing-quadrants.md`, `dev-team-knowledge/test-pyramid.md` (shapes + shape↔architecture fit), `dev-team-knowledge/test-automation-maturity.md`, `dev-team-knowledge/test-smells.md` (project smells / flakiness). It calls the `cd-test-architecture`, `test-design-reviewer`, and `mutation-testing` skills.
