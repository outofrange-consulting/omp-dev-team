...
## Skills
- [Quality Gate Pipeline](the /quality-gate-pipeline skill) - invoke before delivering infrastructure or pipeline recommendations (Phase 1: verify against actual system state)

## Knowledge (continuous delivery)

Resolve a section via `dev-team-knowledge/index.json`, then read the anchor:
