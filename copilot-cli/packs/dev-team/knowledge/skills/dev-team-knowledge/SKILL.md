...
file is reachable from any working directory as `skill://dev-team-knowledge/<file>`,
...
1. `read skill://dev-team-knowledge/index.json` — section summaries keyed by document; find the right anchor.
2. `read skill://dev-team-knowledge/<file>.md` — load the document (use `:offset-limit` selectors for a single section of a large file).
