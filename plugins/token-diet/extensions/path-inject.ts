...
// .profile are never sourced.  Tools installed to ~/.local/bin (codegraph,
// ctx-wire, acli, context-mode, codebase-memory-mcp …) are therefore invisible
// unless the user opened a fresh login shell after install.
//
